  ...
  const projects: Project[] = [
    {
      ...
      description:
        "Interactive GIS platform for tourism management with real-time data visualization and booking integration.",
      image:
    ...
    },
    {
      ...
      description:
        "Comprehensive analytics dashboard for urban planning and infrastructure management in Stone Town.",
      image:
    ...
    },
    {
      ...
      description:
        "Complete school management solution with student tracking, grade management, and parent communication.",
      image:
    ...
    },
    {
      ...
      description:
        "Mobile application for crop monitoring and yield prediction using satellite imagery and IoT sensors.",
      image:
    ...
    },
    {
      ...
      description:
        "Unified healthcare data platform connecting multiple hospitals and clinics across the archipelago.",
      image:
    ...
    },
    {
      ...
      description:
        "Environmental monitoring system for marine protected areas with real-time data collection and reporting.",
      image:
