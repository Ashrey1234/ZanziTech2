  ...
  const services: Service[] = [
    {
      ...
      title: "GIS & Mapping",
      description:
        "Advanced geospatial solutions, mapping services, and location-based analytics for informed decision making.",
    ...
    },
    {
      ...
      description:
        "Full-stack development services creating robust, scalable web applications and enterprise systems.",
    ...
    },
    {
      ...
      title: "IT Support",
      description:
        "Comprehensive technical support and maintenance services to keep your systems running smoothly.",
    ...
    },
    {
      ...
      description:
        "Professional training programs and workshops to enhance your team's technical capabilities.",
    ...
    },
    {
      ...
      description:
        "Expert consultancy services for spatial planning, analysis, and geospatial project management.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            We offer comprehensive technology solutions designed to meet your
            unique business needs and drive digital transformation across
            industries.
          </p>
        </div>
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="flex justify-center mb-6">
                <div className="bg-blue-50 w-20 h-20 rounded-2xl flex items-center justify-center group-hover:bg-blue-100 transition-colors duration-200">
                  {service.icon}
                </div>
              </div>

              {/* Title */}
              <h3 className="text-2xl font-semibold text-gray-900 mb-4 group-hover:text-blue-600 transition-colors duration-200 text-center">
                {service.title}
              </h3>
        ...
        <div className="text-center mt-16">
          <p className="text-gray-600 mb-6">
            Need a custom solution? We'd love to discuss your specific
            requirements.
          </p>
